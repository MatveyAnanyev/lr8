...
uncomone = ['G3SG1 | песчанная буря', 'Nova | Сердечник', 'AUG | Гроза', 'SSG | Голубая хвоя', 'Галиль | Белое напыление']
rare = ['Glock-18 | Карамельное яблоко', 'AWP | Капилляры', 'Mp5-SD | Ликвидация', 'MAC-10 | Заточение', 'SG 553 | Алоха']
epic = ['M4A1-S | Рыцарь', 'AK-47 | Ледяной уголь', 'FAMAS | Быстрое движение', 'Dual Berettas | Турбодвойники', 'MP7 | Дух бездны']
legendary = ['AWP | Dragon lore', 'M4A4 | Вой', 'Керамбит | Градиент', 'Штык-Нож | Волны', 'Нож-бабочка | Волны']
